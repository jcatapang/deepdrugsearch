...
설치 프로세스를 완료하고 Deep Drug Search 소프트웨어를 사용하기 전에 본 EULA 동의서를 주의 깊게 읽으십시오. Deep Drug Search 소프트웨어를 사용할 수 있는 라이선스를 제공하고 보증 정보 및 책임 고지 사항을 포함하고 있다.

Deep Drug Search 소프트웨어의 무료 평가판을 등록할 경우, 본 EULA 협정이 그 평가판을 관할한다. "Approval"을 클릭하거나 Deep Drug Search 소프트웨어를 설치 및/또는 사용함으로써 귀하는 본 소프트웨어에 대한 수락 여부를 확인하고 본 EULA 계약의 조항에 구속되는 것에 동의하는 것이다.

만약 당신이 회사나 다른 법인을 대신하여 본 EULA협정을 체결한다면, 당신은 당신이 그러한 기업과 그 계열사를 이 약관에 구속할 권한이 있음을 나타낸다. 이러한 권한이 없거나 본 EULA 계약의 약관에 동의하지 않는 경우 소프트웨어를 설치하거나 사용하지 마십시오. 본 EULA 계약을 수락하지 마십시오.
...
* 소프트웨어의 전체 또는 일부를 편집, 변경, 수정, 수정, 변환 또는 변경하거나 변경하거나, 소프트웨어의 전체 또는 일부를 다른 소프트웨어와 결합 또는 통합하거나, 소프트웨어를 분해, 분해 또는 역설계하거나, 이러한 작업을 시도하도록 허용
* 이 소프트웨어를 상업적 목적으로 복제, 복사, 배포, 재판매 또는 기타 사용
* 제3자가 대신 또는 제3자를 위해 이 소프트웨어를 사용할 수 있도록 허용
